...
{
    protected $fillable = ['product_id','load_analyses_id','test_conducted','result','rs_total','definition','location','acceptance_criterion','ac_total','date_template','compliance','added_by_id'];
