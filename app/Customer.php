...
class Customer extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'title','code','email', 'password','first_name','last_name','tell','tell_alt','street_address','house_number','company_name','company_address','company_phone','company_location','sms_status','added_by_id','updated_by_id'
    ];
