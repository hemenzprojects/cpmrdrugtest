...
{
    protected $fillable = ['code','name','customer_id','product_type_id','price','actual_price','receipt_num','quantity','overall_status','micro_grade','pharm_grade','phyto_grade','mfg_date','exp_date','indication','single_multiple_lab','dosage',
    'micro_la_conclusion','micro_ea_conclusion','micro_general_conclusion','micro_la_comment','micro_ea_comment','micro_dateanalysed','micro_dateapproved','micro_overall_status','micro_process_status','micro_hod_evaluation','micro_hod_remarks','micro_approved_by','micro_analysed_by','micro_finalapproved_by','micro_datecompleted','micro_reportdatecompleted','micro_finaldateapproved',
    'pharm_testconducted','pharm_additional_testconducted','pharm_overall_status','pharm_hod_evaluation','pharm_datecompleted','pharm_dateanalysed','pharm_dateapproved','pharm_finaldateapproved','pharm_reportdatecompleted','pharm_process_status','pharm_comment','pharm_acute_comment','pharm_dermal_comment','pharm_additional_testcontent','pharm_standard','pharm_result','pharm_approved_by','pharm_finalapproved_by','pharm_analysed_by','pharm_experiment_by','pharm_hod_remarks',
    'phyto_overall_status','phyto_hod_evaluation','phyto_process_status','phyto_hod_remarks','phyto_comment','phyto_dateanalysed','phyto_dateapproved','phyto_datecompleted','phyto_reportdatecompleted','phyto_approved_by','phyto_analysed_by','phyto_finalapproved_by','phyto_finaldateapproved','cover_letter','archive','failed_tag','added_by_id','updated_by_id'];
