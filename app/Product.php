...
class Product extends Model
{
    ...
    'pharm_testconducted','pharm_overall_status','pharm_hod_evaluation','pharm_datecompleted','pharm_dateanalysed','pharm_dateapproved','pharm_finaldateapproved','pharm_reportdatecompleted','pharm_process_status','pharm_comment','pharm_acute_comment','pharm_dermal_comment','pharm_standard','pharm_result','pharm_approved_by','pharm_finalapproved_by','pharm_analysed_by','pharm_experiment_by','pharm_hod_remarks',
