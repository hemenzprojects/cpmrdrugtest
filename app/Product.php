...
class Product extends Model
{
    ...
    'phyto_overall_status','phyto_hod_evaluation','phyto_process_status','phyto_hod_remarks','phyto_comment','phyto_dateanalysed','phyto_dateapproved','phyto_datecompleted','phyto_reportdatecompleted','phyto_approved_by','phyto_analysed_by','phyto_finalapproved_by','phyto_finaldateapproved','cover_letter','failed_tag','added_by_id','updated_by_id'];
