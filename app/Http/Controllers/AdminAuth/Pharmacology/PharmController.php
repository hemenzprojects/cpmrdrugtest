...
class PharmController extends Controller
{
    ...
    public function acceptproduct(AcceptPharmProductRequest $request)
        {   
            ...
            $productdeptstatus = ProductDept::whereIn('id', $deptproduct_id)->where("dept_id", 2)->where("status",  3)->first();
            ...
            ProductDept::whereIN('product_id', $deptproduct_id)->where("dept_id", 2)->update($data);
