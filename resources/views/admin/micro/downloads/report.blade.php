  ...
  <table style="margin: margin-top:4px">
    ...
    <table>
        ...
        <tr>
            ...
            @endif
            <th class="{{($microbial_efficacyanalyses) && count($microbial_efficacyanalyses)>0 ?'font':'font1'}}">Acceptance Criterion <br> BP
  ...
  <tr class="{{($microbial_efficacyanalyses) && count($microbial_efficacyanalyses) < 1 ?'space':'space1'}}">
    <td class="font " style="border: 0px solid">
      ...
      ?>
        ...
        <img src="{{asset(\App\Admin::find($micro_approved_by)? \App\Admin::find($micro_approved_by)->sign_url:'')}}" class="" width="70%" style="margin-top: 5px; margin-bottom: 5px"><br>
        @endif
        -----------------------------<br>
    ...
    <td class="font" style=" border: 0px solid">
        ...
        <img src="{{asset(\App\Admin::find($micro_finalapproved_by)? \App\Admin::find($micro_finalapproved_by)->sign_url:'')}}" class="" width="70%" style="margin-top: 5px; margin-bottom: 5px"><br>
        @endif
