        ...
        <div class="card" style="padding: 15px;     background-color: #ffffffe6;">
            <form action="{{url('admin/micro/report/update',['id' => $report_id])}}" method="POST">
                ...
                <div class="text-center">
                    ...
                    <h5 class="font" style="font-size:16px"> Microbiology Department Centre for Plant Medicine Research
                    </h5>
                ...
                <form action="">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered nowrap dataTable">
                            ...
                            <tbody>
                                ...
                                @for ($i = 0; $i < count($microbial_loadanalyses); $i++) <tr>
                                    <td class="font">

                                        <p>{!! $microbial_loadanalyses[$i]->test_conducted !!}</p>
                                        <input type="hidden" class="form-control" name="loadanalyses"
                                            placeholder="Result"
                                            value="{{$microbial_loadanalyses[$i]->test_conducted}}">
                                    </td>
                                    <td class="font">
                                    ...
                                    ?>
                                        <p>
                                            <input type="hidden" id="rstotal{{$i}}"
                                                value="{{$microbial_loadanalyses[$i]->rs_total}}">
                                            {{-- <input type="text" required class="form-control {{$i<2?'date-inputmask':''}}"
                                            id="result_disabled{{$i}}" name="result[]"
                                            placeholder="{{$i>1?'Result':''}}"
                                            value="{{$show_microbial_loadanalyses[$i]->result}}"> --}}
                        ...
                        <div class="row">
                            <div class="col-md=-6">
                                @for ($i = 0; $i < count($microbial_loadanalyses); $i++) @if ($i<1) <p
                                    style="font-style: italic; margin:5px">
                            ...
                            <div class="col-md=-6">
                                ...
                                @for ($i = 0; $i < count($microbial_loadanalyses); $i++) @if ($i < 1) @if
                                    ($microbial_loadanalyses[0]->rs_total == 9900000000 ||
                                    $microbial_loadanalyses[1]->rs_total == 9900000000)
                                    <p style="font-style: italic; margin:5px; font-size:12px"><sup>3</sup>TNTC = Too
                                        Numerous To Count</p>
                                    @endif
                                    @endif
                                    @endfor
                        ...
                        <table class="table table-striped table-bordered nowrap dataTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <input type="hidden" class="form-control" id="pi_zone"
                                        value="76899233403932{{$efficacyanalyses->efficacy_analyses_id}}">
                                    <td class="font">
                    ...
                    @for ($i = 0; $i < count($microbial_efficacyanalyses); $i++) @if ($i<1) {!!
