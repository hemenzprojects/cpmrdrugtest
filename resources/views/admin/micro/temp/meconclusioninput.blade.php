    ...
    <div class="row">
      <div class="col-md-4">
        ...
        <label class="custom-control custom-checkbox">
            <input type="checkbox" class="custom-control-input" id="me_general_conclusion" name="me_general_conclusion" value="432">
      ...
      <div class="col-md-8">
        ...
        <select  name="micro_ea_conclution_option" class="form-control" id="micro_ea_conclution_option">
          <option value="{{$product->micro_ea_conclution}}">{{$product->micro_ea_conclution}}</option>
      ...
      <textarea class="form-control" name="micro_ea_conclution_text" rows="4">{{$product->micro_ea_conclution}}</textarea>
