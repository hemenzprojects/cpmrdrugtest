            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="alert alert-warning alert-dismissible fade show" role="alert">
                        ...
                        </strong> You have {{count($weekly_microcompletedreports)}} new report(s) from Microbiology
                        Department.
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-12">
                            ...
                            {{ Form::close() }}
                            <form id="microarchiveproduct"
                                action="{{url('admin/sid/hod_office/micro_completed_report/update')}}"
                                        ...
                                        <tr>
                                            ...
                                            <td class="font">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <a target="_blank"
                                                            href="{{route('admin.sid.print_microreport',['id' => $product->id])}}">
                                                            <button type="button"
                                                    ...
                                                    <div class="col-md-6">
                                                        <a
                                                            href="{{route('admin.sid.microreport.pdf',['id' => $product->id])}}">
                                            ...
                                            <td class="font">
                                                <div class="form-check mx-sm-2">
                                                    <label class="custom-control custom-checkbox">
                                                        <input type="checkbox" class="custom-control-input microselect"
