                ...
                <div class="card-body">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-12">
                            ...
                            <form  id="pharmarchiveproduct" action="{{url('admin/sid/hod_office/pharm_completed_report/update')}}" class="forms-sample" method="POST">
                                {{ csrf_field() }}
                                ...
                                <tbody>                                                
                                    ...
                                    <td class="font">
                                        <div class="form-check mx-sm-2">
                                            ...
                                            <input type="checkbox" class="custom-control-input pharmselect"  value="{{$product->id}}" >
