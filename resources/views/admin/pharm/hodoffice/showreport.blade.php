                           ...
                           <form action="{{url('admin/pharm/hod_office/editreport',['id' => $pharmreports->id])}}" method="post">
                                     ...
                                     <div class="col-sm-8">
                                         ...
                                         <h4 class="font" style="font-size:18px; margin:10px; margin-top:1px"><strong> REMARKS: </strong></h4>
                                             <p style="font-size: 16px">
                                                 <textarea class="textarea" class="form-control" name="pharm_acute_comment"  rows="6"> {{$pharmreports->pharm_acute_comment}} </textarea>
                                             </p>
                                         </div>
                                         </div>
                                     </div>
                                     ...
                                     <div class="card">
                                         <div class="row">
                                             <div class="col-sm-7">
                                                 ...
                                                 <textarea class="textarea" name="pharm_standard" style="font-size: 16px;  text-align: justify ;" class="form-control" rows="9"> {!! $pharmreports->pharm_standard !!} </textarea>

                                                 <h4 class="font" style="font-size:18px; margin:10px; margin-top:15px"><strong> RESULTS: </strong></h4>
                                                 <p >
                                                     <textarea class="textarea" name="pharm_result" style="font-size: 16px; text-align: justify ;" class="form-control" rows="10"> {{$pharmreports->pharm_result}} </textarea>
                                                 </p>

                                                 <h4 class="font" style="font-size:18px; margin:20px; margin-top:15px"> <strong>REMARKS: </strong></h4>

                                                 <p >
                                                     <textarea class="textarea" name="pharm_dermal_comment" id=""  style="font-size: 16px" class="form-control" rows="3"> {{$pharmreports->pharm_dermal_comment}} </textarea>
                             ...
                             <div class="card">
                                <div class="col-sm-12" style="margin-bottom: 20px">
                                    ...
                                    <textarea class="textarea" class="pat" style="font-size: 16px text-align: justify " class="form-control" rows="1" name="additional_testcontent" >
                             ...
                             <div class="row"  style="margin:10px; margin-top:1px">
                                 <div class="col-sm-8">
                                     ...
                                     <textarea  class="textarea" name="pharm_hod_remarks" class="form-control" id="exampleTextarea1" rows="4">{{$pharmreports->pharm_hod_remarks}}</textarea>
