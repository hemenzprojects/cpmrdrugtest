    ...
    <div class="page-header">
        <div class="row align-items-end">
            ...
            <div class="col-lg-6">
                ...
                {{form::token()}}
               <div class="input-group">
                <span style="margin: 5px">From</span> {{ Form::selectMonth('month',array('class'=>'form-control','placeholder'=>'')) }}
              
                <span style="margin: 5px">To </span>{{ Form::selectMonth('month',array('class'=>'form-control','placeholder'=>'')) }}
                <span style="margin: 5px"> Year {{ Form::selectRange('year',date('Y') -1, date('Y'), array('class'=>'form-control','placeholder'=>'')) }}

                </span><button type="submit" class="btn btn-primary mr-2">search</button>  
                </div>
               {{ Form::close() }} --}}
            </div>
            <div class="col-lg-2">
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-xl-4">
            <div class="card">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <form action="{{route('admin.pharm.pending_reports.index',['id' => $product_type->id])}}" method="POST">
                            {{ csrf_field() }}
                    ...
                    <div class="col-md-6">
                        <a href="{{route('admin.pharm.completed_reports.index',['id' => $product_type->id])}}">
                            <div class="card-block text-center">
                                <div class="state">
                                ...
                                <small class="text-small mt-10 d-block">Total number of Approved /completed product </small>
                            </div>
                        </a>
                    </div>
                </div>
