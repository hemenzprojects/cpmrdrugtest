...
<table style="margin-top:%"> 
  ...
  <tr>
    <td class="font" style="border: #fff" >
        ...
        <img src="{{asset(\App\Admin::find($phyto_approved_by)? \App\Admin::find($phyto_approved_by)->sign_url:'')}}" class="" width="70%" style="margin-top: 5px; margin-bottom: 5px"><br>
        @endif
        -----------------------------<br>
    ...
    <td class="font" style="border: #fff">
        ...
        <img src="{{asset(\App\Admin::find($phyto_finalapproved_by)? \App\Admin::find($phyto_finalapproved_by)->sign_url:'')}}" class="" width="70%" style="margin-top: 5px; margin-bottom: 5px"><br>
        @endif
